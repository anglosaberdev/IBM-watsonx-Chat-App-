...
def generate():
    ...
    try:
        ...
        # التعديل هنا: إنشاء قاموس يحتوي على النص والوقت المستغرق
        response_data = {
            "response": result.content,          # استخراج نص الإجابة من كائن AIMessage
            "duration": time.time() - start_time # حساب الوقت
        }
